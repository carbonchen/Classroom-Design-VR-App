...
{
    public class SteamVR_LeftLaserPointer : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (bHit && leftTrigger.GetState(pose.inputSource))
            {
            ...
            if (leftTrigger != null && leftTrigger.GetState(pose.inputSource))
            {
            ...
            if (leftTrigger.stateUp && lastSelected != null)
            {
